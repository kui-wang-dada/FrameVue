...
module.exports = {
  ...
  resolve: {
    ...
    alias: Object.assign({}, pathMap, {
      ...
      customer: resolve('src/components/pages/customer'),
      servant: resolve('src/components/pages/servant'),
      manager: resolve('src/components/pages/manager'),
      login: resolve('src/components/pages/login'),
